...
namespace MARGO
{
    public partial class FrmEmployeeMaster : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Employee_MasterProperty EmployeeMasterProperty = new Employee_MasterProperty();
            Int64 Code = Val.ToInt64(txtEmployeeCode.Text);
            EmployeeMasterProperty.Employee_Code = Val.ToInt64(Code);
            EmployeeMasterProperty.Employee_Name = txtEmployeeName.Text;
            ...
            EmployeeMasterProperty.Department_Code = Val.ToInt64(LookupDepartment.EditValue);
        ...
        private void dgvEmployeeMaster_RowClick(object sender, DevExpress.XtraGrid.Views.Grid.RowClickEventArgs e)
        {
            if (e.RowHandle >= 0)
            {
                if (e.Clicks == 2)
                {
                    ...
                    txtEmployeeCode.Text = Convert.ToString(Drow["EMPLOYEE_CODE"]);
                    txtEmployeeName.Text = Convert.ToString(Drow["EMPLOYEE_NAME"]);
