...
namespace MARGO.Report
{
    public partial class FrmTransaction_View : Form
    {
        ...
        public void ShowForm(string pStrReportGroup)
        {
            ...
            Global.LOOKUPParty(ChkCmbParty);
            ChkCmbParty.Focus();
            this.Show();
            SetControl();
        ...
        private void FrmReportList_Shown(object sender, EventArgs e)
        {
            ...
            if (RptName.ToString() == "Transaction View")
            {
                ...
                mDTDetail.Rows.Add("Tran Date", "TranDate");
            ...
            ListGroupBy.Default = "TranDate,Party_Name,Cash_Type,Remark";// ObjReportDetailProperty.Default_Group_By;
