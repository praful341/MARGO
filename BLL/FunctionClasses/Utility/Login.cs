...
namespace BLL.FunctionClasses.Utility
{
    public class Login
    {
        ...
        public int CheckLogin(string UserName, string Password)
        {
            ...
            {
                GlobalDec.gEmployeeProperty.Employee_Code = Val.ToInt64(Drow["EMPLOYEE_CODE"]);
                GlobalDec.gEmployeeProperty.Employee_Name = Val.ToString(Drow["EMPLOYEE_NAME"]);
                ...
                GlobalDec.gEmployeeProperty.Department_Code = Val.ToInt64(Drow["DEPARTMENT_CODE"]);
