...
namespace BLL.FunctionClasses.Master
{
    public class EmployeeMaster
    {
        ...
        public int Save(Employee_MasterProperty pClsProperty)
        {
            ...
            Request.AddParams("@EMPLOYEE_NAME", pClsProperty.Employee_Name, DbType.String, ParameterDirection.Input);
            ...
            Request.AddParams("@USER_EMPLOYEE_CODE", GlobalDec.gEmployeeProperty.Employee_Code, DbType.Int32, ParameterDirection.Input);
            Request.AddParams("@COMPUTER_IP", GlobalDec.gStrComputerIP, DbType.String, ParameterDirection.Input); 

            Request.CommandText = "Employee_Master_Save";
        ...
        public DataTable GetData()
        {
            ...
            Request.CommandText = "Employee_Master_GetFullDetail";
            Request.CommandType = CommandType.StoredProcedure;
        ...
        {
            Request Request = new Request();
            Request.AddParams("@User_Code", GlobalDec.gEmployeeProperty.Employee_Code, DbType.Int32);
            ...
            Request.CommandText = "MMS_THEME_MASTER_SAVE";
            Request.CommandType = CommandType.StoredProcedure;
            return Ope.ExecuteNonQuery(BLL.DBConnections.ConnectionString, BLL.DBConnections.ProviderName, Request);
        }
