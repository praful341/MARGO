...
{
    public partial class FrmGReportViewerTransaction : Form
    {
        ...
        public FrmGReportViewerTransaction()
        {
            InitializeComponent();
        }

        public FrmGReportViewerTransaction(DataTable pDTab, string pStrOrderBy, string pStrGroupBy, string pStrReportName, int pIntReportCode)
        {
            InitializeComponent();
