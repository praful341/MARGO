...
using Global = MARGO.Class.Global;
    ...
    public partial class FrmGReportViewer : Form
    {
        ...
        public void FillGrid()
        {
            ...
            try
            {
                ...
                else if (ReportHeaderName.ToString() == "Transaction View")
                {
                    GridView1.Columns["Credit_Amt"].Summary.Add(SummaryItemType.Sum, "Credit_Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Credit_Amt", GridView1.Columns["Credit_Amt"]);
                    GridView1.Columns["Debit_Amt"].Summary.Add(SummaryItemType.Sum, "Debit_Amt");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Debit_Amt", GridView1.Columns["Debit_Amt"]);
                    GridView1.Columns["Balance"].Summary.Add(SummaryItemType.Sum, "Balance");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Balance", GridView1.Columns["Balance"]);
                    //GridView1.Columns["Out_Carat"].Summary.Add(SummaryItemType.Sum, "Out_Carat");
                    //GridView1.GroupSummary.Add(SummaryItemType.Sum, "Out_Carat", GridView1.Columns["Out_Carat"]);
                    //GridView1.Columns["Closing_BalCarat"].Summary.Add(SummaryItemType.Sum, "Closing_BalCarat");
                    //GridView1.GroupSummary.Add(SummaryItemType.Sum, "Closing_BalCarat", GridView1.Columns["Closing_BalCarat"]);
                ...
                else if (ReportHeaderName.ToString() == "Employee Issue Return")
                {
                    GridView1.Columns["Issue_Lot"].Summary.Add(SummaryItemType.Sum, "Issue_Lot");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Issue_Lot", GridView1.Columns["Issue_Lot"]);
                    GridView1.Columns["Issue_Pcs"].Summary.Add(SummaryItemType.Sum, "Issue_Pcs");
                    ...
                    GridView1.Columns["Issue_Carat"].Summary.Add(SummaryItemType.Sum, "Issue_Carat");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Issue_Carat", GridView1.Columns["Issue_Carat"]);
                    GridView1.Columns["Receive_Lot"].Summary.Add(SummaryItemType.Sum, "Receive_Lot");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Receive_Lot", GridView1.Columns["Receive_Lot"]);
                    GridView1.Columns["Receive_Pcs"].Summary.Add(SummaryItemType.Sum, "Receive_Pcs");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Receive_Pcs", GridView1.Columns["Receive_Pcs"]);
                    GridView1.Columns["Receive_Carat"].Summary.Add(SummaryItemType.Sum, "Receive_Carat");
                    GridView1.GroupSummary.Add(SummaryItemType.Sum, "Receive_Carat", GridView1.Columns["Receive_Carat"]);
                ...
                //string[] grp = Group_By_Tag.Split(',');
                //if (grp.Length > 0)
                //{
                //    for (int f = 0; f < grp.Length - 1; f++)
                //    {
                //        if (grp[f].Trim().Length > 0)
                //            GridView1.Columns[grp[f].ToString()].GroupIndex = f;
                //    }
                //}
                //                    break;
                //                case "AVG":
                //                    GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Average, DRow["FIELD_NAME"].ToString(), StrFormat);
                //                    GridView1.GroupSummary.Add(SummaryItemType.Average, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);
                //                    break;
                //                case "COUNT":

                //GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Count, DRow["FIELD_NAME"].ToString(), StrFormat);
                //GridView1.GroupSummary.Add(SummaryItemType.Count, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);

                //                    break;
                //                case "MAX":
                //                    GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Max, DRow["FIELD_NAME"].ToString(), StrFormat);
                //                    GridView1.GroupSummary.Add(SummaryItemType.Max, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);
                //                    break;
                //                case "MIN":
                //                    GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Min, DRow["FIELD_NAME"].ToString(), StrFormat);
                //                    GridView1.GroupSummary.Add(SummaryItemType.Min, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);
                //                    break;
                //                case "WEI.AVG":
                //                    GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Custom, DRow["FIELD_NAME"].ToString(), StrFormat);
                //                    GridView1.GroupSummary.Add(SummaryItemType.Custom, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);
                //                    break;
                //                case "CUSTOME":
                //                    GridView1.Columns[DRow["FIELD_NAME"].ToString()].Summary.Add(SummaryItemType.Custom, DRow["FIELD_NAME"].ToString(), StrFormat);
                //                    GridView1.GroupSummary.Add(SummaryItemType.Custom, DRow["FIELD_NAME"].ToString(), GridView1.Columns[DRow["FIELD_NAME"].ToString()], StrFormat);
                ...
                //    if (Val.ToString(Report_Type).ToUpper() == "SUMMRY")
                //    {
