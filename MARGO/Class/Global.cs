...
namespace MARGO.Class
{
    ...
    static class Global
    {
        ...
        internal static void Message(string gStrPermissionViwMsg)
        {
        ...
        public static void OpenForm(string pStrFormName, string pStrReportCode, string pStrNamespace = "Report")
        {
            ...
            {
                Confirm(pStrFormName + " :  Form Not Exists");
            }
        }
        ...
        public static void LOOKUPCountry(LookUpEdit lookup)
        {
            ...
            Country.DefaultView.Sort = "COUNTRY_NAME asc";
        ...
        public static void LOOKUPState(LookUpEdit lookup)
        {
            ...
            State.DefaultView.Sort = "STATE_NAME asc";
        ...
        public static void LOOKUPCity(LookUpEdit lookup)
        {
            ...
            City.DefaultView.Sort = "CITY_NAME asc";
        ...
        public static void LOOKUPCompany(LookUpEdit lookup)
        {
            ...
            Company.DefaultView.Sort = "COMPANY_NAME asc";
        ...
        public static void LOOKUPBranch(LookUpEdit lookup)
        {
            ...
            Branch.DefaultView.Sort = "BRANCH_NAME asc";
        ...
        public static void LOOKUPLocation(LookUpEdit lookup)
        {
            ...
            Location.DefaultView.Sort = "LOCATION_NAME asc";
        ...
        public static void LOOKUPDepartment(LookUpEdit lookup)
        {
            ...
            lookup.Properties.ValueMember = "DEPARTMENT_CODE";
        ...
        public static void LOOKUPProcess(LookUpEdit lookup)
        {
            ...
            Process.DefaultView.Sort = "PROCESS_NAME asc";
            lookup.Properties.DataSource = Process;
            lookup.Properties.ValueMember = "PROCESS_CODE";
        ...
        public static void LOOKUPShape(LookUpEdit lookup)
        {
            ...
            DataTable Shape = objShape.GetData();
            Shape.DefaultView.Sort = "SHAPE_NAME asc";
            lookup.Properties.DataSource = Shape;
            lookup.Properties.ValueMember = "SHAPE_CODE";
        ...
        public static void LOOKUPSieve(LookUpEdit lookup)
        {
            ...
            Sieve.DefaultView.Sort = "SIEVE_NAME asc";
            lookup.Properties.DataSource = Sieve;
            lookup.Properties.ValueMember = "SIEVE_CODE";
            lookup.Properties.DisplayMember = "SIEVE_NAME";
            //   lookup.EditValue = null;
            lookup.ClosePopup();
        }
        public static void LOOKUPParty(LookUpEdit lookup, Party_MasterProperty _Type = null)
        {
            PartyMaster objParty = new PartyMaster();
            if (_Type == null)
            {
                _Type = new Party_MasterProperty();
            }
            _Type.Active = 1;
            DataTable Party = objParty.GetData(_Type);
            Party.DefaultView.Sort = "PARTY_NAME asc";
            lookup.Properties.DataSource = Party;
            lookup.Properties.ValueMember = "PARTY_CODE";
            lookup.Properties.DisplayMember = "PARTY_NAME";
            //   lookup.EditValue = null;
            lookup.ClosePopup();
        }

        public static void LOOKUPRoughTypeCode(LookUpEdit lookup)
        {
            RoughTypeMaster objRoughType = new RoughTypeMaster();
            DataTable RoughType = objRoughType.GetData();
            RoughType.DefaultView.Sort = "ROUGH_TYPE_NAME asc";
            lookup.Properties.DataSource = RoughType;
            lookup.Properties.ValueMember = "ROUGH_TYPE_CODE";
            lookup.Properties.DisplayMember = "ROUGH_TYPE_NAME";
            //   lookup.EditValue = null;
            lookup.ClosePopup();
        }

        public static void LOOKUPRough(LookUpEdit lookup)
        {
            RoughMaster objRough = new RoughMaster();
            DataTable Rough = objRough.GetRoughMasterData();
            Rough.DefaultView.Sort = "ROUGH_NAME asc";
            lookup.Properties.DataSource = Rough;
            lookup.Properties.ValueMember = "ROUGH_NAME";
            lookup.Properties.DisplayMember = "ROUGH_NAME";
            //   lookup.EditValue = null;
            lookup.ClosePopup();
        }
        ...
        public static void LOOKUPDepartmentRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ...
            lookup.ValueMember = "DEPARTMENT_CODE";
            lookup.DisplayMember = "DEPARTMENT_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPSieveRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            SieveMaster objSieve = new SieveMaster();
            DataTable Sieve = objSieve.GetData();
            Sieve.DefaultView.Sort = "SIEVE_NAME asc";
            lookup.DataSource = Sieve;
            lookup.ValueMember = "SIEVE_CODE";
            lookup.DisplayMember = "SIEVE_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPClarityRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ClarityMaster objClarity = new ClarityMaster();
            DataTable Clarity = objClarity.GetData();
            Clarity.DefaultView.Sort = "CLARITY_NAME asc";
            lookup.DataSource = Clarity;
            lookup.ValueMember = "CLARITY_CODE";
            lookup.DisplayMember = "CLARITY_NAME";
            //   lookup.EditValue = null;            
        }
        ...
        public static void LOOKUPEmployee(LookUpEdit lookup)
        {
            ...
            DataTable Employee = objEmployee.GetData();
            Employee.DefaultView.Sort = "EMPLOYEE_NAME asc";
            lookup.Properties.DataSource = Employee;
            lookup.Properties.ValueMember = "EMPLOYEE_CODE";
        ...
        public static void LOOKUPColor(LookUpEdit lookup)
        {
            ...
            Color.DefaultView.Sort = "COLOR_NAME asc";
            lookup.Properties.DataSource = Color;
            lookup.Properties.ValueMember = "COLOR_CODE";
            lookup.Properties.DisplayMember = "COLOR_NAME";
            //   lookup.EditValue = null;
            lookup.ClosePopup();
        }

        public static void LOOKUPClarity(LookUpEdit lookup, string typ = "")
        {
            lookup.Properties.DataSource = null;
            ClarityMaster objClarity = new ClarityMaster();
            DataTable Clarity = objClarity.GetData();
            DataTable dtClarity = Clarity.Clone();
            if (Clarity.Rows.Count > 0)
            {
                if (typ == "Clv")
                {
                    if (Clarity.Select("TYPE='CLV'").Count() > 0)
                        dtClarity = Clarity.Select("TYPE='CLV'").CopyToDataTable();
                }
                else if (typ == "Mfg")
                {
                    if (Clarity.Select("TYPE='MFG'").Count() > 0)
                        dtClarity = Clarity.Select("TYPE='MFG'").CopyToDataTable();
                }
                else
                {
                    dtClarity = Clarity;
            ...
            dtClarity.DefaultView.Sort = "CLARITY_NAME asc";
            lookup.Properties.DataSource = dtClarity;
            lookup.Properties.ValueMember = "CLARITY_CODE";
            lookup.Properties.DisplayMember = "CLARITY_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPClarity(CheckedComboBoxEdit lookup, string typ = "")
        {
            lookup.Properties.DataSource = null;
            ClarityMaster objClarity = new ClarityMaster();
            DataTable Clarity = objClarity.GetData();
        ...
        {
            if (BLL.GlobalDec.gEmployeeProperty.Employee_Code == 1)
            {
                return true;
            }
            else
        ...
        public static bool MCheckEmpty(GridColumn _Colname, GridView _gridview, string msg)
        {
            bool flag = true;
            for (int i = 0; i < _gridview.RowCount; i++)
            {
                if (_gridview.GetRowCellValue(i, _Colname) != null)
                {
                    if (_gridview.GetRowCellValue(i, _Colname).ToString().Trim().ToLower() == string.Empty)
                    {
                        MessageBox.Show(msg + " Required.", "MARGO", MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                        _gridview.FocusedRowHandle = (i);
                        _gridview.FocusedColumn = (_Colname);
        ...
        public static void LOOKUPCompany(CheckedComboBoxEdit lookup)
        {
            CompanyMaster objCompany = new CompanyMaster();
            DataTable Company = objCompany.GetData();
            Company.DefaultView.Sort = "COMPANY_NAME asc";
        ...
        public static void LOOKUPBranch(CheckedComboBoxEdit lookup)
        {
            BranchMaster objBranch = new BranchMaster();
            DataTable Branch = objBranch.GetData();
            Branch.DefaultView.Sort = "BRANCH_NAME asc";
        ...
        public static void LOOKUPLocation(CheckedComboBoxEdit lookup)
        {
            LocationMaster objLocation = new LocationMaster();
            DataTable Location = objLocation.GetData();
            Location.DefaultView.Sort = "LOCATION_NAME asc";
        ...
        public static void LOOKUPDepartment(CheckedComboBoxEdit lookup)
        {
            DepartmentMaster objDepartment = new DepartmentMaster();
            DataTable Department = objDepartment.GetData();
            Department.DefaultView.Sort = "DEPARTMENT_NAME asc";
        ...
        public static void LOOKUPShape(CheckedComboBoxEdit lookup)
        {
            ShapeMaster objShape = new ShapeMaster();
            DataTable Shape = objShape.GetData();
            Shape.DefaultView.Sort = "SHAPE_NAME asc";
        ...
        public static void LOOKUPRoughTypeCode(CheckedComboBoxEdit lookup)
        {
            RoughTypeMaster objRoughType = new RoughTypeMaster();
            DataTable RoughType = objRoughType.GetData();
            RoughType.DefaultView.Sort = "ROUGH_TYPE_NAME asc";
        ...
        public static void LOOKUPRough(CheckedComboBoxEdit lookup)
        {
            RoughMaster objRough = new RoughMaster();
            DataTable Rough = objRough.GetData();
            Rough.DefaultView.Sort = "ROUGH_NAME asc";
            lookup.Properties.DataSource = Rough;
            lookup.Properties.ValueMember = "ROUGH_NAME";
            lookup.Properties.DisplayMember = "ROUGH_NAME";
        ...
        public static void LOOKUPEmployee(CheckedComboBoxEdit lookup)
        {
            EmployeeMaster objEmployee = new EmployeeMaster();
            DataTable Employee = objEmployee.GetData();
            Employee.DefaultView.Sort = "EMPLOYEE_NAME asc";
        ...
        public static void LOOKUPColor(CheckedComboBoxEdit lookup)
        {
            ColorMaster objColor = new ColorMaster();
            DataTable Color = objColor.GetData();
            Color.DefaultView.Sort = "COLOR_NAME asc";
        ...
        public static void LOOKUPClarity(CheckedComboBoxEdit lookup)
        {
            ClarityMaster objClarity = new ClarityMaster();
            DataTable Clarity = objClarity.GetData();
            Clarity.DefaultView.Sort = "CLARITY_NAME asc";
            lookup.Properties.DataSource = Clarity;
            lookup.Properties.ValueMember = "CLARITY_CODE";
            lookup.Properties.DisplayMember = "CLARITY_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPParty(CheckedComboBoxEdit lookup, Party_MasterProperty _Type = null)
        {
            PartyMaster objParty = new PartyMaster();
            if (_Type == null)
            {
        ...
        public static void LOOKUPCity(CheckedComboBoxEdit lookup)
        {
            CityMaster objCity = new CityMaster();
            DataTable City = objCity.GetData();
            City.DefaultView.Sort = "CITY_NAME asc";
        ...
        // End
        public static void LOOKUPRoughRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            RoughMaster objRough = new RoughMaster();
            DataTable Rough = objRough.GetData();
            Rough.DefaultView.Sort = "ROUGH_NAME asc";
            lookup.DataSource = Rough;
            lookup.ValueMember = "ROUGH_NAME";
            lookup.DisplayMember = "ROUGH_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPEmployeeRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            EmployeeMaster objEmployee = new EmployeeMaster();
            DataTable Employee = objEmployee.GetData();
            Employee.DefaultView.Sort = "EMPLOYEE_NAME asc";
            lookup.DataSource = Employee;
            lookup.ValueMember = "EMPLOYEE_CODE";
            lookup.DisplayMember = "EMPLOYEE_NAME";
        }

        public static void LOOKUPProcessRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ProcessMaster objProcess = new ProcessMaster();
            DataTable Process = objProcess.GetData();
            Process.DefaultView.Sort = "PROCESS_NAME asc";
            lookup.DataSource = Process;
            lookup.ValueMember = "PROCESS_CODE";
            lookup.DisplayMember = "PROCESS_NAME";
        }

        public static void LOOKUPShapeRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ShapeMaster objShape = new ShapeMaster();
            DataTable Shape = objShape.GetData();
            Shape.DefaultView.Sort = "SHAPE_NAME asc";
            lookup.DataSource = Shape;
            lookup.ValueMember = "SHAPE_CODE";
            lookup.DisplayMember = "SHAPE_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPColorRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            ColorMaster objColor = new ColorMaster();
            DataTable Color = objColor.GetData();
            Color.DefaultView.Sort = "COLOR_NAME asc";
            lookup.DataSource = Color;
            lookup.ValueMember = "COLOR_CODE";
            lookup.DisplayMember = "COLOR_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPRoughTypeRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup)
        {
            RoughTypeMaster objRoughType = new RoughTypeMaster();
            DataTable RoughType = objRoughType.GetData();
            RoughType.DefaultView.Sort = "ROUGH_TYPE_NAME asc";
            lookup.DataSource = RoughType;
            lookup.ValueMember = "ROUGH_TYPE_CODE";
            lookup.DisplayMember = "ROUGH_TYPE_NAME";
            //   lookup.EditValue = null;            
        }

        public static void LOOKUPClarityRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup, string typ = "")
        {
        ...
        public static void LOOKUPPartyRep(DevExpress.XtraEditors.Repository.RepositoryItemLookUpEdit lookup, Party_MasterProperty _Type = null)
        {
            PartyMaster objParty = new PartyMaster();
            if (_Type == null)
            {
            ...
            lookup.ValueMember = "PARTY_CODE";
            lookup.DisplayMember = "PARTY_NAME";
        }

        public static void LOOKUPJangedForPrint(LookUpEdit lookup, string Date_)
        {
            ClvMixDeptIssRet objJangedPrint = new ClvMixDeptIssRet();
            DataTable JangedPrint = objJangedPrint.tGetData(Date_);
            JangedPrint.DefaultView.Sort = "BILL_OF_ENTRY_NO asc";
            lookup.Properties.DataSource = JangedPrint;
            lookup.Properties.ValueMember = "BILL_OF_ENTRY_NO";
            lookup.Properties.DisplayMember = "BILL_OF_ENTRY_NO";
            // lookup.EditValue = null;             
        }
