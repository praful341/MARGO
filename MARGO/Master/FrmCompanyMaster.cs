...
namespace MARGO
{
    public partial class FrmCompanyMaster : Form
    {
        ...
        private bool ValSave()
        {
            ...
            {
                MARGO.Class.Global.Confirm("Company Name Is Required");
                txtCompanyName.Focus();
                return false;
            }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            Int64 Code = Val.ToInt64(txtCompanyCode.Text);
            ...
            if (IntRes == -1)
            {
                MARGO.Class.Global.Confirm("Error In Save Company Details");
                TabRegisterDetail.SelectedTabPageIndex = 0;
                txtCompanyName.Focus();
            }
            else
            {
                if (Code == 0)
                {
                    MARGO.Class.Global.Confirm("Company Details Data Save Successfully");
                }
                else
                {
                    MARGO.Class.Global.Confirm("Company Details Data Update Successfully");
                }               
                GetData();
